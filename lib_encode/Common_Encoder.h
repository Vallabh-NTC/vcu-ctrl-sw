...
/*****************************************************************************
   \brief The AL_Encoder_SetSAO requests the encoder to enable or disable SAO
   for the future frames.
   \param[in] pEnc Pointer on an encoder object
   \param[in] bSAOEnabled "true" to enable SAO "false" to disable it.
   \return true on success, false on error : call AL_Common_Encoder_GetLastError
   to retrieve the error code
*****************************************************************************/
bool AL_Common_Encoder_SetSAO(AL_TEncCtx* pCtx, bool bSAOEnabled);
...
/*****************************************************************************
   ...
   \param[in] pEnc Pointer on an encoder object
   \param[in] iMode The new loop filter Mode
